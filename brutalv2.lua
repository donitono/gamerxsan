...
local function createCompleteGUI()
    ...
    local FloatingButton = guiComponents.floating.button
    local FloatingShadow = guiComponents.floating.shadow
    local FloatingButtonText = guiComponents.floating.text
    local FloatingButtonClick = guiComponents.floating.clickButton
    local FloatingTooltip = guiComponents.floating.tooltip
    
    -- Security components
    local AdminDetectionButton = guiComponents.security.adminButton
    local AdminDetectionWarna = guiComponents.security.adminIndicator
    local ProximityAlertButton = guiComponents.security.proximityButton
    local ProximityAlertWarna = guiComponents.security.proximityIndicator
    local AutoHideButton = guiComponents.security.autoHideButton
    local AutoHideWarna = guiComponents.security.autoHideIndicator
    local SecurityStatsText = guiComponents.security.statsText
    
    -- Advanced components
    local LuckBoostButton = guiComponents.advanced.luckButton
    local LuckBoostWarna = guiComponents.advanced.luckIndicator
    local WeatherBoostButton = guiComponents.advanced.weatherButton
    local WeatherBoostWarna = guiComponents.advanced.weatherIndicator
    local SmartFishingButton = guiComponents.advanced.smartButton
    local SmartFishingWarna = guiComponents.advanced.smartIndicator
    local FishValueTextBox = guiComponents.advanced.fishValueTextBox
    local AdvancedStatsText = guiComponents.advanced.advStatsText
